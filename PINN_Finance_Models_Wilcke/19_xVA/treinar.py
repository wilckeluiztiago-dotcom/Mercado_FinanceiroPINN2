"""
Treinamento completo – xVA Nonlinear
...
def main():
    ...
    device = cfg.device
    print(f"[xVA Nonlinear] device={device}")
    ...
    plt.tight_layout()
    plt.savefig("19_xVA_results.png", dpi=120)
    torch.save({"model": model.state_dict(), "history": history}, "19_xVA_pinn.pth")
    print("Salvo.")

"""
PINN completa e modular – Liquidação Ótima – Almgren-Chriss
Formulação: Luiz Tiago Wilcke – Capítulo 19
...
class PhysicsInformedLoss:
    ...
    Implementação do residual conforme Capítulo 19 de Wilcke.
    """
    ...
    def residual(self, *inputs):
        ...
        Residual da HJB; controle ótimo v* obtido por FOC e substituído.
        """

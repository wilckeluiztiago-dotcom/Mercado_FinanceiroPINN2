"""
Pipeline de treinamento híbrido – Liquidação Ótima – Almgren-Chriss
Metodologia Adam + L-BFGS: Luiz Tiago Wilcke – Capítulo 19
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Liquidação Ótima – Almgren-Chriss] Iniciando treinamento em {device}")
    ...
    torch.save(model.state_dict(), f"15_almgrenchriss_pinn.pth")

"""
Pipeline de treinamento híbrido – Volatilidade Local de Dupire – Problema Inverso
Metodologia Adam + L-BFGS: Luiz Tiago Wilcke – Capítulo 9
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Volatilidade Local de Dupire – Problema Inverso] Iniciando treinamento em {device}")
    ...
    torch.save(model.state_dict(), f"07_dupire_pinn.pth")

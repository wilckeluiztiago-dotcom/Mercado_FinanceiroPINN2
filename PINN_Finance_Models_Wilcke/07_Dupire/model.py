"""
PINN completa e modular – Volatilidade Local de Dupire – Problema Inverso
Formulação: Luiz Tiago Wilcke – Capítulo 9
...
class PhysicsInformedLoss:
    ...
    Implementação do residual conforme Capítulo 9 de Wilcke.
    """
    ...
    def residual(self, *inputs):
        ...
        Parametrizar σ_loc por uma rede neural; residual da equação de Dupire + fit aos preços de mercado.
        """

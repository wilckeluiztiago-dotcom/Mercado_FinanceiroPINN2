"""
Pipeline de treinamento híbrido – Modelo CIR de Taxa de Juros e Precificação de Títulos
Metodologia Adam + L-BFGS: Luiz Tiago Wilcke – Capítulo 7
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Modelo CIR de Taxa de Juros e Precificação de Títulos] Iniciando treinamento em {device}")
    ...
    torch.save(model.state_dict(), f"05_cir_pinn.pth")

"""
Pipeline de treinamento híbrido – Market Making Avellaneda-Stoikov + Fokker-Planck
Metodologia Adam + L-BFGS: Luiz Tiago Wilcke – Capítulo 8
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Market Making Avellaneda-Stoikov + Fokker-Planck] Iniciando treinamento em {device}")
    ...
    torch.save(model.state_dict(), f"06_avellanedastoikov_pinn.pth")

"""
PINN completa e modular – Market Making Avellaneda-Stoikov + Fokker-Planck
Formulação: Luiz Tiago Wilcke – Capítulo 8
...
class PhysicsInformedLoss:
    ...
    Implementação do residual conforme Capítulo 8 de Wilcke.
    """
    ...
    def residual(self, *inputs):
        ...
        Residual do HJB de inventário + residual da FP; acoplamento via intensidade de chegada de ordens.
        """

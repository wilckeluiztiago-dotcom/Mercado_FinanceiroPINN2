"""
Treinamento completo – Avellaneda-Stoikov Market Making
Inspirado no livro de Luiz Tiago Wilcke (Cap. 8)
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Avellaneda-Stoikov Market Making] device={device}")
    ...
    plt.tight_layout()
    plt.savefig("06_AvellanedaStoikov_results.png", dpi=120)
    torch.save({"model": model.state_dict(), "history": history}, "06_AvellanedaStoikov_pinn.pth")
    print("Salvo.")

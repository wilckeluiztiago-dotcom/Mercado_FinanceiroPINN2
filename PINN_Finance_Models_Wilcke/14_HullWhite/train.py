"""
Pipeline de treinamento híbrido – Modelo de Hull-White e Calibração Dinâmica
Metodologia Adam + L-BFGS: Luiz Tiago Wilcke – Capítulo 18
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Modelo de Hull-White e Calibração Dinâmica] Iniciando treinamento em {device}")
    ...
    torch.save(model.state_dict(), f"14_hullwhite_pinn.pth")

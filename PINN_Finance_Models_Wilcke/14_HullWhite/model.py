"""
PINN completa e modular – Modelo de Hull-White e Calibração Dinâmica
Formulação: Luiz Tiago Wilcke – Capítulo 18
...
class PhysicsInformedLoss:
    ...
    Implementação do residual conforme Capítulo 18 de Wilcke.
    """
    ...
    def residual(self, *inputs):
        ...
        Parametrizar θ(t) por rede ou spline neural; residual da EDP + fit à curva de juros.
        """

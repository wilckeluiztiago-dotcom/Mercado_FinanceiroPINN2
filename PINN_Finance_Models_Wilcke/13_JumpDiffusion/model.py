"""
PINN completa e modular – Salto-Difusão de Merton – PIDE
Formulação: Luiz Tiago Wilcke – Capítulo 17
...
class PhysicsInformedLoss:
    ...
    Implementação do residual conforme Capítulo 17 de Wilcke.
    """
    ...
    def residual(self, *inputs):
        ...
        Amostrar saltos dentro do grafo; residual do termo local + termo integral Monte-Carlo.
        """

"""
Pipeline de treinamento híbrido – Salto-Difusão de Merton – PIDE
Metodologia Adam + L-BFGS: Luiz Tiago Wilcke – Capítulo 17
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Salto-Difusão de Merton – PIDE] Iniciando treinamento em {device}")
    ...
    torch.save(model.state_dict(), f"13_jumpdiffusion_pinn.pth")

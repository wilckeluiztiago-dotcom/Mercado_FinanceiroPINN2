"""
Treinamento completo – Carbon Abatement HJB
Inspirado no livro de Luiz Tiago Wilcke (Cap. 43)
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Carbon Abatement HJB] device={device}")
    ...
    plt.tight_layout()
    plt.savefig("20_CarbonHJB_results.png", dpi=120)
    torch.save({"model": model.state_dict(), "history": history}, "20_CarbonHJB_pinn.pth")
    print("Salvo.")

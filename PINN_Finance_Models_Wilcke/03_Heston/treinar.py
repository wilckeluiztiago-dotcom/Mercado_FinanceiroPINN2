"""
Pipeline de treinamento – Heston Stochastic Vol
...
def main():
    ...
    device = cfg.device
    print(f"[Heston Stochastic Vol] {device}")
    ...
    params = {
        ...
        "kappa": 2.0, "theta": 0.04, "xi": 0.3, "rho": -0.7, "q": 0.0,
    }
    ...
    plt.title("Loss – Heston Stochastic Vol"); plt.tight_layout()
    fname = "03_Heston"

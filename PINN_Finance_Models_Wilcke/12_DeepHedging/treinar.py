"""
Treinamento completo – Deep Hedging
Inspirado no livro de Luiz Tiago Wilcke (Cap. 16)
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Deep Hedging] device={device}")
    ...
    plt.tight_layout()
    plt.savefig("12_DeepHedging_results.png", dpi=120)
    torch.save({"model": model.state_dict(), "history": history}, "12_DeepHedging_pinn.pth")
    print("Salvo.")

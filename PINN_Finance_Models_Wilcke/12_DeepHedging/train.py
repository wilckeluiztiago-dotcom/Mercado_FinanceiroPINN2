"""
Pipeline de treinamento híbrido – Deep Hedging – Cobertura Ótima
Metodologia Adam + L-BFGS: Luiz Tiago Wilcke – Capítulo 16
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Deep Hedging – Cobertura Ótima] Iniciando treinamento em {device}")
    ...
    torch.save(model.state_dict(), f"12_deephedging_pinn.pth")

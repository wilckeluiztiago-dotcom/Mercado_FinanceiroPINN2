"""
Pipeline de treinamento híbrido – Alocação de Portfólio de Merton – Equação HJB
Metodologia Adam + L-BFGS: Luiz Tiago Wilcke – Capítulo 6
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Alocação de Portfólio de Merton – Equação HJB] Iniciando treinamento em {device}")
    ...
    torch.save(model.state_dict(), f"04_mertonhjb_pinn.pth")

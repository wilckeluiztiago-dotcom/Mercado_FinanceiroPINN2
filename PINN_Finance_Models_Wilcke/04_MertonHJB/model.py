"""
PINN completa e modular – Alocação de Portfólio de Merton – Equação HJB
Formulação: Luiz Tiago Wilcke – Capítulo 6
...
class PhysicsInformedLoss:
    ...
    Implementação do residual conforme Capítulo 6 de Wilcke.
    """
    ...
    def residual(self, *inputs):
        ...
        Derivar controles ótimos analíticos π* e c* e substituir na HJB, depois residual da EDP resultante.
        """

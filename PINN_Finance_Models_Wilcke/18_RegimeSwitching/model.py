"""
PINN completa e modular – Mudança de Regime Macro-Financeira
Formulação: Luiz Tiago Wilcke – Capítulo 29
...
class PhysicsInformedLoss:
    ...
    Implementação do residual conforme Capítulo 29 de Wilcke.
    """
    ...
    def residual(self, *inputs):
        ...
        Arquitetura multi-head (uma saída por regime); residual acoplado por taxas de transição.
        """

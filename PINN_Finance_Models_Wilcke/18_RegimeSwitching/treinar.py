"""
Treinamento completo – Regime Switching
Inspirado no livro de Luiz Tiago Wilcke (Cap. 29)
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Regime Switching] device={device}")
    ...
    plt.tight_layout()
    plt.savefig("18_RegimeSwitching_results.png", dpi=120)
    torch.save({"model": model.state_dict(), "history": history}, "18_RegimeSwitching_pinn.pth")
    print("Salvo.")

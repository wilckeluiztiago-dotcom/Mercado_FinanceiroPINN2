"""
Pipeline de treinamento híbrido – Mudança de Regime Macro-Financeira
Metodologia Adam + L-BFGS: Luiz Tiago Wilcke – Capítulo 29
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Mudança de Regime Macro-Financeira] Iniciando treinamento em {device}")
    ...
    torch.save(model.state_dict(), f"18_regimeswitching_pinn.pth")

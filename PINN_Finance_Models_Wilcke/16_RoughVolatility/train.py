"""
Pipeline de treinamento híbrido – Volatilidade Rough e fPINN (Operador de Caputo)
Metodologia Adam + L-BFGS: Luiz Tiago Wilcke – Capítulos 22 e 27
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Volatilidade Rough e fPINN (Operador de Caputo)] Iniciando treinamento em {device}")
    ...
    torch.save(model.state_dict(), f"16_roughvolatility_pinn.pth")

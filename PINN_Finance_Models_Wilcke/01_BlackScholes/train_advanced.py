...
from model_advanced import AdvancedBlackScholesLoss, build_advanced_bs_model
from utils.sampling import collocation_points_bs
from utils.optimizers import HybridOptimizer
from utils.advanced_networks import ResidualAdaptiveSampler, AdaptiveLossWeights
...
def main():
    ...
    # Validação
    from model import analytical_call

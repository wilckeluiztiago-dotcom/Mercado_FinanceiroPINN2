"""
Treinamento completo – Multi-Asset Basket Option
Inspirado no livro de Luiz Tiago Wilcke (Cap. 15)
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Multi-Asset Basket Option] device={device}")
    ...
    plt.tight_layout()
    plt.savefig("11_MultiAsset_results.png", dpi=120)
    torch.save({"model": model.state_dict(), "history": history}, "11_MultiAsset_pinn.pth")
    print("Salvo.")

"""
Pipeline de treinamento híbrido – Opções sobre Cesta Multiativo (Alta Dimensão)
Metodologia Adam + L-BFGS: Luiz Tiago Wilcke – Capítulo 15
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Opções sobre Cesta Multiativo (Alta Dimensão)] Iniciando treinamento em {device}")
    ...
    torch.save(model.state_dict(), f"11_multiasset_pinn.pth")

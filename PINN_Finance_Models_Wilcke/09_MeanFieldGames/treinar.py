"""
Treinamento completo – Mean Field Games
...
def main():
    ...
    device = cfg.device
    print(f"[Mean Field Games] device={device}")
    ...
    plt.tight_layout()
    plt.savefig("09_MeanFieldGames_results.png", dpi=120)
    torch.save({"model": model.state_dict(), "history": history}, "09_MeanFieldGames_pinn.pth")
    print("Salvo.")

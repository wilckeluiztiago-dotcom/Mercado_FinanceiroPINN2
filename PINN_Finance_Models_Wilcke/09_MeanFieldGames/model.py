"""
PINN completa e modular – Jogos de Campo Médio (Mean Field Games)
Formulação: Luiz Tiago Wilcke – Capítulos 11 e 23
...
class PhysicsInformedLoss:
    ...
    Implementação do residual conforme Capítulos 11 e 23 de Wilcke.
    """
    ...
    def residual(self, *inputs):
        ...
        Duas redes (u e m); residual HJB + residual FP + acoplamento de campo médio.
        """

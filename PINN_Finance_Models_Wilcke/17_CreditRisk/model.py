"""
PINN completa e modular – Risco de Crédito Estrutural (Merton + Black-Cox)
Formulação: Luiz Tiago Wilcke – Capítulo 26
...
class PhysicsInformedLoss:
    ...
    Implementação do residual conforme Capítulo 26 de Wilcke.
    """
    ...
    def residual(self, *inputs):
        ...
        Residual da EDP com fronteira absorvente; probabilidade de default via autograd.
        """

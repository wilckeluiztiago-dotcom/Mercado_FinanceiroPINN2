"""
Treinamento completo – Credit Risk Merton/Black-Cox
Inspirado no livro de Luiz Tiago Wilcke (Cap. 26)
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Credit Risk Merton/Black-Cox] device={device}")
    ...
    plt.tight_layout()
    plt.savefig("17_CreditRisk_results.png", dpi=120)
    torch.save({"model": model.state_dict(), "history": history}, "17_CreditRisk_pinn.pth")
    print("Salvo.")

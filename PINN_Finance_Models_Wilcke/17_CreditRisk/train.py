"""
Pipeline de treinamento híbrido – Risco de Crédito Estrutural (Merton + Black-Cox)
Metodologia Adam + L-BFGS: Luiz Tiago Wilcke – Capítulo 26
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[Risco de Crédito Estrutural (Merton + Black-Cox)] Iniciando treinamento em {device}")
    ...
    torch.save(model.state_dict(), f"17_creditrisk_pinn.pth")

"""
Pipeline de treinamento híbrido – DeepONet / Operador Neural para EDPs Financeiras
Metodologia Adam + L-BFGS: Luiz Tiago Wilcke – Capítulo 10
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[DeepONet / Operador Neural para EDPs Financeiras] Iniciando treinamento em {device}")
    ...
    torch.save(model.state_dict(), f"08_deeponet_pinn.pth")

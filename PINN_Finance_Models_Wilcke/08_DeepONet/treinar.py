"""
Treinamento completo – DeepONet Financial Operator
Inspirado no livro de Luiz Tiago Wilcke (Cap. 10)
"""
import sys
sys.path.append("..")
import torch
...
def main():
    ...
    device = cfg.device
    print(f"[DeepONet Financial Operator] device={device}")
    ...
    plt.tight_layout()
    plt.savefig("08_DeepONet_results.png", dpi=120)
    torch.save({"model": model.state_dict(), "history": history}, "08_DeepONet_pinn.pth")
    print("Salvo.")

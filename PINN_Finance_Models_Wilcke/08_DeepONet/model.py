"""
PINN completa e modular – DeepONet / Operador Neural para EDPs Financeiras
Formulação: Luiz Tiago Wilcke – Capítulo 10
...
class PhysicsInformedLoss:
    ...
    Implementação do residual conforme Capítulo 10 de Wilcke.
    """
    ...
    def residual(self, *inputs):
        ...
        Perda de operador + perda física (resíduo da EDP no ponto de saída).
        """
